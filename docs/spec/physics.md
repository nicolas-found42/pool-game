...
| 2. Cuts at known angles | throw vs cut angle and speed | TP B-3's six measured points, with the **μb stick/slip parametrisation pinned first** and the **sign convention stated** (§3.2); compare magnitudes. Max throw ≈ 5°, zero at gearing | the refit (a, b, c = 0.0010 / 0.2732 / 0.620) takes the six-point residual from 4.167° to **0.908°** — a number that is only meaningful once the formulation is fixed |
